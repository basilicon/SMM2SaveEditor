...
{
    /// <summary>
    /// Cryptographic key lookup tables extracted from the Super Mario Maker 2 binary.
    /// Each 64-uint table is used by Nintendo's ENL key-derivation routine to generate
    /// 128-bit AES keys and CMAC verification keys for different save and course file types.
    /// </summary>
    public static class KeyTables
    {
        /// <summary>
        /// Key derivation table for course files: course_data_XXX.bcd
        /// </summary>
        public static readonly uint[] Course = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for course thumbnail files: course_thumb_XXX.btl
        /// </summary>
        public static readonly uint[] Thumbnail = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for main save data: save.dat
        /// </summary>
        public static readonly uint[] Save = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for later progress / state: later.dat
        /// </summary>
        public static readonly uint[] Later = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for story mode progress: quest.dat
        /// </summary>
        public static readonly uint[] Quest = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for replay files: course_replay_XXX.dat
        /// </summary>
        public static readonly uint[] Replay = new uint[64]
        {
            0xFAE9A964, 0xD15BE83B, 0xA8935637, 0x6BFB6458,
            0xF431F0BD, 0x9A1726E1, 0xCA4D4B97, 0x4679263D,
            0x038A3639, 0x1756A282, 0xB38EA547, 0x3A1E61CD,
            0x594C78AC, 0x8A2BA1D6, 0xA83A362C, 0x5B5A20B7,
            0xE6677DE5, 0x0D4E7289, 0xEEB36782, 0x64980EEC,
            0xEB5CBCDC, 0xD39B30E4, 0x6C61F7DC, 0x6D1839C7,
            0xE1FC8B5A, 0x1EAE0662, 0x9F5996F7, 0xF1E5724D,
            0xAD7CD854, 0x0840CF0F, 0x7E9E433D, 0xE76FEFD0,
            ...
            0x50B3DE30, 0x15C034BF, 0x2140EB8E, 0x03972860,
        ...
        /// <summary>
        /// Key derivation table for network files / courses cache
        /// </summary>
        public static readonly uint[] Network = new uint[64]
        {
        ...
        /// <summary>
        /// Key derivation table for user info data
        /// </summary>
        public static readonly uint[] Info = new uint[64]
        {
            ...
            0x0D167C45, 0xED8A94F7, 0x38A635AD, 0x2F1A9428,
            ...
            0x295A6CC2, 0x5FE0ECCC, 0xE9156285, 0x04911709,
            0x58D23398, 0x9F03CE36, 0xCF071EB6, 0x0B46C7A3,
        ...
        /// <summary>
        /// Additional unknown table from SMM2 executable
        /// </summary>
        public static readonly uint[] Unknown = new uint[64]
        {
            0x7EF2CF75, 0xBCC721F3, 0x3B3DEA13, 0x71703BC9,
            0x59671165, 0x3B67EBBB, 0x09576D83, 0x4642B550,
            ...
            0x16C2CABD, 0xCBCA7DDF, 0x40E76BF4, 0x0EEAAB9C,
            ...
            0x716D14D6, 0x0A328CD5, 0xB48AD50B, 0x5618FD4B,
            ...
            0xF8D36974, 0x8AD5E61F, 0x8887B5A8, 0x0303C31A
        };
    }
}
